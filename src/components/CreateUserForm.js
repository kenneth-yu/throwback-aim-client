...
const CreateUserForm = ({username, password, passwordConfirm, createUser, onChange}) =>{
    ...
    return(
      <form className="create-user-form" onSubmit={(e)=> {createUser(e, username, password)}}>
        ...
        Create a password: <br/><input className="sign-up-form" type="password" name="password" value={password} onChange={onChange}/><br/><br/>
        Confirm password: <br/><input className="sign-up-form" type="password" name="passwordConfirm" value={passwordConfirm} onChange={onChange}/><br/><br/>
